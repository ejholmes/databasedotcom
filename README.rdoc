...
=== Authentication via Warden
If you decided to use the {Warden middleware}[https://github.com/ejholmes/warden-salesforce] provided, a client will be automatically instantiated for you at:

    env['warden'].user.client

You can use the Warden middlware by including it with:

    use Warden::Manager do |manager|
      manager.default_strategies :salesforce
      manager.failure_app = BadAuthentication

      manager[:salesforce_client_id]    = ENV['SALESFORCE_CLIENT_ID']
      manager[:salesforce_secret]       = ENV['SALESFORCE_CLIENT_SECRET']

      manager[:salesforce_scopes]       = 'api'
      manager[:salesforce_oauth_domain] = ENV['SALESFORCE_OAUTH_DOMAIN']
